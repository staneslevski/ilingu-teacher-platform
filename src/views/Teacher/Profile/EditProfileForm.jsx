...
class EditProfile extends React.Component {
  ...
  componentDidMount() {
    let teacherProfile = this.props.userInfo.teacher;
    console.log("teacherProfile: ", teacherProfile);
    this.setState({
      profile: {
        teacherName: EditProfile.testEmpty(teacherProfile.teacherName),
        englishName: EditProfile.testEmpty(teacherProfile.englishName),
        phone: EditProfile.testEmpty(teacherProfile.phone),
        aboutMe: EditProfile.testEmpty(teacherProfile.aboutMe),
        hobbies: EditProfile.testEmpty(teacherProfile.hobbies),
        interests: EditProfile.testEmpty(teacherProfile.interests),
        languages: EditProfile.testEmpty(teacherProfile.languages),
        weChatId: EditProfile.testEmpty(teacherProfile.weChatId),
        country: EditProfile.testEmpty(teacherProfile.country),
        teacherTimezone: EditProfile.testEmpty(teacherProfile.teacherTimezone),
  ...
  handleUploadProfile = () => {
    this.props.updateTeacher(this.props.userInfo.teacher.userId, this.state.profile);
  };
  ...
  render() {
    ...
    const { profile } = this.state;
    let uploading = this.props.userInfo.isUpdatingTeacher;
        ...
        if (error) {
          ...
          if (result && result.event === "success") {
            ...
            if (result.info.hasOwnProperty('secure_url')) {
              ...
              this.handleUploadProfile().catch(error => {
                console.log(error);
              })
            } else {
